...
function compressedTar(name, declaredSize, payload = Buffer.alloc(0)) {
...
function qualifiedArchive(manifest, extraEntries = []) {
  return tarArchive([
    { name: "package/", type: "5" },
...
async function createPackFixture(t, prefix) {
