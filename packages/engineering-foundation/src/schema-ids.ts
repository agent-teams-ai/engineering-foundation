// Module assembly selects feature-owned identities in the established public order.
import { createSchemaList } from "./features/configuration-input/module.js";
...
const { schemaIds: FOUNDATION_SCHEMA_IDS, firstSchemaId } = createSchemaList([
