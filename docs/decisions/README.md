...
Architecture decisions use a four-digit sequence. Accepted decisions are
immutable historical evidence. A change requires a superseding ADR instead of
...
- [ADR-0004: Released Public API Baselines](0004-released-public-api-baselines.md)
- [ADR-0005: Repository Security Baseline](0005-repository-security-baseline.md)
...
- [ADR-0017: Staged Scaffolding Recipe Qualification](0017-staged-scaffolding-recipe-qualification.md)
