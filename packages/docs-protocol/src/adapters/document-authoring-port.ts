...
import type { DocumentAuthoringDescriptionV2, DocumentAuthoringPortV2 } from "../domain/model-v2.js";
import type { DocumentAuthoringPortV3 } from "../domain/model-v3.js";
...
export class NodeDocumentAuthoringPort implements DocumentAuthoringPortV3 {
  ...
  plan(input: Parameters<DocumentAuthoringPortV2["plan"]>[0]) {
