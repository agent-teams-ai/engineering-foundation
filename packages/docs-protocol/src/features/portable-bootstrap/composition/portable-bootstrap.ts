...
import type { PortableBootstrapInput, ApplyPortableBootstrapInput, BootstrapTransactions } from "../application/bootstrap-model.js";
...
export const recoverPortableBootstrap: BootstrapTransactions["recover"] = (input) => nodeBootstrapTransactions.recover(input);
