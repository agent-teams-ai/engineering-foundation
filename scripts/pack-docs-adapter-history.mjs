export function assertPackedDocsAdapterHistory(transitionCatalog) {
  ...
  const stable26 = transitionCatalog.directTargetBundles.find(
  ...
  const stable25 = transitionCatalog.directTargetBundles.find(
    ({ cohort }) => cohort.cohortId === "docs-2026-09-16-stable25"
  );
  if (stable25?.cohort.recordDigest !== "sha256:105c34ecc7fc422939b43daaca513f9ce630ce69d4a2820d39423fcdc13dcc61" ||
      ...
      stable25.cohort.packages.docsProtocolAgentTeams.version !== "0.2.9" ||
