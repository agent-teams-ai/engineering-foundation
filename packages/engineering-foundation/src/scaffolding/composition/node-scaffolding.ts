...
export function createScaffoldFilesystemDependencies(
  ...
  return {
    ...
    assessPlanAuthority: (root, plan) => assessScaffoldPlanAuthority(root, plan, assertSchema),
...
export function createNodeScaffoldingApi(
  ...
  return createScaffoldingApi({
    planScaffoldFromFile: (options) => planAuthorityScaffoldFromFile(options, assertSchema),
