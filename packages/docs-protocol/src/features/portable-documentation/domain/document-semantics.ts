import type { DocumentJsonValue } from "./metadata.js";

import type { DocsCodeAnchor } from "./documentation-model.js";
...
function object(value: DocumentJsonValue): Record<string, DocumentJsonValue> {
  if (typeof value !== "object" || value === null || Array.isArray(value)) {
    throw new DocsProfileError("Each code anchor must be an object.");
  }
  return value as Record<string, DocumentJsonValue>;
}

export function normalizeCodeAnchors(values: readonly DocumentJsonValue[]): readonly DocsCodeAnchor[] {
