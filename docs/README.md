...
| SDK growth checkpoint | [EF C0 contract](reference/sdk-growth-c0.md) | Boundary revision 6; v5 wire bytes retained, authority v3 qualifies metadata roots; external activation remains separate |
