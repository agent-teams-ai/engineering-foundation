...
import type { ScaffoldAuthorityDependencies } from "../node/scaffold-authority-dependencies.js";
import type {
...
dependencies: ScaffoldAuthorityDependencies): Promise<AuthorityScaffoldPlan> {
  ...
  return compileAuthorityScaffoldPlan(input, dependencies.createRegistry());
}
