...
| Document authoring | [Document authoring protocol](architecture/document-authoring-protocol.md) | Read-only catalog and pure Plan compiler implemented; mutation runtime pending |
