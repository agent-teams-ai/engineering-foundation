...
- [`6710434`](https://github.com/agent-teams-ai/engineering-foundation/commit/6710434f4914860313b06095e610ec3b875d06ad) Thanks [@777genius](https://github.com/777genius)! - Exclude existing installation and Git infrastructure from disposable qualification copies using the shared evidence policy, preserving consumer source and recovery authority.
...
- [#211](https://github.com/agent-teams-ai/engineering-foundation/pull/211) [`a0c4d37`](https://github.com/agent-teams-ai/engineering-foundation/commit/a0c4d373b291e3925f218f9233caa5d902b5a950) Thanks [@777genius](https://github.com/777genius)! - Add portable documentation adoption, bounded ranked agent context, automatic profile discovery, and a read-only MCP adapter for repositories using the open documentation protocol.

### Patch Changes

- [#213](https://github.com/agent-teams-ai/engineering-foundation/pull/213) [`6150e41`](https://github.com/agent-teams-ai/engineering-foundation/commit/6150e41a55886319d71bfc8db90c733e551ef1af) Thanks [@777genius](https://github.com/777genius)! - Qualify the exact public npm and pnpm installation workflow, package provenance,
  release evidence, and optional read-only MCP transport for open-source consumers.
...
- Updated dependencies [[`da4a859`](https://github.com/agent-teams-ai/engineering-foundation/commit/da4a859eb1bd86e9a51373751c5329d45a120fc5)]:
  - @agent-teams/engineering-foundation@0.17.0-rc.8
...
- Updated dependencies [[`ed0a09b`](https://github.com/agent-teams-ai/engineering-foundation/commit/ed0a09b2b2c807e8362c0afe5a84d1d2bff2e982)]:
  - @agent-teams/engineering-foundation@0.17.0-rc.4
...
- Updated dependencies [[`b228651`](https://github.com/agent-teams-ai/engineering-foundation/commit/b2286510150293e7355a7abe284432a9e3d3671d), [`055f86e`](https://github.com/agent-teams-ai/engineering-foundation/commit/055f86eab2413cca4f0ff269bdaff3d979dd0f70)]:
...
publisher enrollment. Do not adopt this version. Use a supported release
candidate when one becomes available. See ADR-0029.
