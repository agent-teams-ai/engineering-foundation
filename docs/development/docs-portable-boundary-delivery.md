...
| Reviewed bootstrap bytes | Bound, unpublished | Ubuntu candidate-evidence job in run `33788347016` re-packed all three packages from merge ref `b39728e70bd131cdf62119a43d4d27b099d28808`; receipt `sha256:fb1f0747fbdbe2cbbc21a29533253d6c868ccbcf8e42b889d483fdca86e93597` binds the catalog package trees and SHA-512 archive integrity values. The isolated stage now serializes manifests in the same top-level order as the protected writer. |
