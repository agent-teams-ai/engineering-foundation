import { readQualificationProfile } from "../../portable-documentation/qualification.js";
export { createProtocol } from "../../docs-command/qualification.js";
...
export async function interruptAndRecover(input: {
  ...
  const profile = await readQualificationProfile({
