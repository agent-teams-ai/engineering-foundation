...
import { auditInputPath, auditRead, AUDIT_MAX_BYTES } from "../dist/capabilities/public-api-compatibility/adapters/outbound/filesystem/public-api-audit-inputs.js";
